                                    ...
                                    <ul className="py-3 bg-white dark:bg-black overflow-y-scroll max-h-[300px] relative">
                                        {
                                            autoCompleteerror
                                                ...
                                                : locations.map((location) => (
                                                    <li key={location.latitude} className=" inset-1 flex items-center justify-between my-3  py-2 px-3 w-full h-20 hover:bg-gray-100 dark:hover:bg-green-500">
                                                        ...
                                                        <div className="w-fit">
                                                            <button
                                                                onClick={() => { handleAddLocation(location.formattedAddress, location.latitude, location.longitude) }}
                                                                type="button"
